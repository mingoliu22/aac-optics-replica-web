...
const translations = {
  zh: {
    ...
    // News
    'news.title': '新闻中心',
    'news.subtitle': '了解AAC Optics的最新动态、产品发布和行业资讯',
    'news.latest': '最新动态',
    'news.readMore': '查看更多',
    'news.featured': '特别报道',
    'news.companyNews': '公司新闻',
    'news.loading': '加载中...',
    'news.noNews': '暂无已发布的新闻',
    'news.adminNote': '管理员可以登录后台添加新闻内容',
    'news.fetchError': '获取新闻失败',
    'news.tryAgain': '请稍后重试',
    'news.newsletter.title': '订阅我们的新闻简报',
    'news.newsletter.description': '第一时间获取AAC Optics的最新动态和行业资讯',
    'news.newsletter.placeholder': '请输入您的邮箱地址',
    'news.newsletter.subscribe': '订阅',
    
    // Products
    'products.categories.all': '全部产品',
    'products.categories.allTitle': '产品系列',
    'products.categories.allDesc': '我们提供全系列的光学产品，从基础器件到完整系统解决方案',
    'products.categories.optics': '光学器件',
    'products.categories.opticsTitle': '光学器件',
    'products.categories.opticsDesc': '高精度光学透镜、反射镜、棱镜等核心光学器件，为您的光学系统提供基础支撑',
    'products.categories.systems': '光学系统',
    'products.categories.systemsTitle': '光学系统',
    'products.categories.systemsDesc': '完整的光学系统解决方案，包含成像系统、激光测距系统等专业设备',
    'products.categories.components': '光学组件',
    'products.categories.componentsTitle': '光学组件',
    'products.categories.componentsDesc': '各类专业光学组件，包含光纤耦合器、光学棱镜等精密配件',
    'products.specifications': '主要规格',
    'products.viewDetails': '查看详情',
    'products.inquiry': '询价',
    'products.customTitle': '需要定制产品？',
    'products.customDesc': '我们的工程师团队可以根据您的具体需求设计和制造专业的光学产品',
    'products.contactEngineer': '联系工程师',
    'products.items.lens.name': '高精度光学透镜',
    'products.items.lens.description': '采用先进工艺制造的高精度光学透镜，适用于各种光学系统',
    'products.items.lens.spec1': '直径: 10-200mm',
    'products.items.lens.spec2': '精度: λ/10',
    'products.items.lens.spec3': '镀膜: 可定制',
    'products.items.mirror.name': '激光反射镜',
    'products.items.mirror.description': '高反射率激光反射镜，适用于激光加工和测量系统',
    'products.items.mirror.spec1': '反射率: >99.5%',
    'products.items.mirror.spec2': '损伤阈值: 高',
    'products.items.mirror.spec3': '尺寸: 可定制',
    'products.items.imaging.name': '成像光学系统',
    'products.items.imaging.description': '完整的成像光学系统解决方案，包含镜头组和控制系统',
    'products.items.imaging.spec1': '分辨率: 4K+',
    'products.items.imaging.spec2': '焦距: 可调',
    'products.items.imaging.spec3': '接口: 标准化',
    'products.items.prism.name': '光学棱镜',
    'products.items.prism.description': '各类光学棱镜，用于光路转换和光谱分析',
    'products.items.prism.spec1': '材质: K9/石英',
    'products.items.prism.spec2': '精度: 高精度',
    'products.items.prism.spec3': '镀膜: 可选',
    'products.items.coupler.name': '光纤耦合器',
    'products.items.coupler.description': '高效光纤耦合器，确保光信号的稳定传输',
    'products.items.coupler.spec1': '插损: <0.5dB',
    'products.items.coupler.spec2': '回损: >50dB',
    'products.items.coupler.spec3': '工作温度: -40~+85°C',
    'products.items.ranging.name': '激光测距系统',
    'products.items.ranging.description': '高精度激光测距系统，适用于工业测量和自动化',
    'products.items.ranging.spec1': '测量范围: 0.1-100m',
    'products.items.ranging.spec2': '精度: ±1mm',
    'products.items.ranging.spec3': '激光等级: Class 2',
    
    // Careers
    'careers.hero.title': '加入我们的团队',
    'careers.hero.description': '在AAC Optics，我们致力于光学技术的创新与发展。如果您对光学充满热情，希望在一个充满挑战和机遇的环境中成长，我们期待您的加入。',
    'careers.whyUs.title': '为什么选择我们',
    'careers.whyUs.description': '我们提供有竞争力的薪酬福利，完善的职业发展平台，让每一位员工都能在这里实现自己的价值。',
    'careers.positions.title': '招聘职位',
    'careers.positions.description': '我们正在寻找优秀的人才加入我们的团队，共同推动光学技术的发展。',
    'careers.experience': '经验要求',
    'careers.jobDescription': '职位描述',
    'careers.requirements': '任职要求',
    'careers.apply': '申请职位',
    'careers.contact.title': '联系我们',
    'careers.contact.description': '如果您对我们的职位感兴趣，或者希望了解更多信息，请随时与我们联系。',
    'careers.contact.hrEmail': 'HR邮箱',
    'careers.contact.phone': '联系电话',
    'careers.contact.address': '公司地址',
    'careers.benefits.training.title': '培训发展',
    'careers.benefits.training.description': '完善的培训体系，助力员工职业发展',
    'careers.benefits.team.title': '团队氛围',
    'careers.benefits.team.description': '开放包容的工作环境，和谐的团队氛围',
    'careers.benefits.office.title': '办公环境',
    'careers.benefits.office.description': '现代化办公环境，完善的办公设施',
    'careers.benefits.balance.title': '工作平衡',
    'careers.benefits.balance.description': '弹性工作时间，倡导工作生活平衡',
    'careers.jobs.optical.title': '光学工程师',
    'careers.jobs.optical.department': '研发部',
    'careers.jobs.optical.location': '上海',
    'careers.jobs.optical.type': '全职',
    'careers.jobs.optical.experience': '3-5年',
    'careers.jobs.optical.description': '负责光学产品的设计和开发，包括光学系统建模、仿真分析等工作。',
    'careers.jobs.optical.req1': '光学工程或相关专业硕士及以上学历',
    'careers.jobs.optical.req2': '熟悉光学设计软件如Zemax、CodeV等',
    'careers.jobs.optical.req3': '有光学产品开发经验',
    'careers.jobs.optical.req4': '良好的英语读写能力',
    'careers.jobs.sales.title': '销售经理',
    'careers.jobs.sales.department': '销售部',
    'careers.jobs.sales.location': '北京',
    'careers.jobs.sales.type': '全职',
    'careers.jobs.sales.experience': '2-4年',
    'careers.jobs.sales.description': '负责光学产品的市场开拓和客户维护，制定销售策略并完成销售目标。',
    'careers.jobs.sales.req1': '市场营销或相关专业本科及以上学历',
    'careers.jobs.sales.req2': '有B2B销售经验，光学行业优先',
    'careers.jobs.sales.req3': '优秀的沟通和谈判能力',
    'careers.jobs.sales.req4': '能够适应出差工作',
    'careers.jobs.quality.title': '质量工程师',
    'careers.jobs.quality.department': '质量部',
    'careers.jobs.quality.location': '深圳',
    'careers.jobs.quality.type': '全职',
    'careers.jobs.quality.experience': '1-3年',
    'careers.jobs.quality.description': '负责产品质量管理体系建设，质量问题分析和改进，供应商质量管理。',
    'careers.jobs.quality.req1': '质量管理或相关专业本科及以上学历',
    'careers.jobs.quality.req2': '熟悉ISO9001质量管理体系',
    'careers.jobs.quality.req3': '有光学或精密制造行业经验优先',
    'careers.jobs.quality.req4': '具备质量分析和解决问题的能力',
    
    // About - additional translations
    'about.companyIntro1': 'AAC Optics成立于2010年，是一家专业从事光学器件研发、生产和销售的高新技术企业。我们拥有先进的生产设备和专业的技术团队，致力于为客户提供高品质的光学产品和解决方案。',
    'about.companyIntro2': '经过多年的发展，公司已成为国内外知名的光学器件供应商，产品广泛应用于激光加工、精密测量、科学研究等领域。我们始终坚持"质量第一、客户至上"的经营理念，为客户创造更大的价值。',
    'about.valuesTitle': '企业价值观',
    'about.timelineTitle': '发展历程',
    'about.ctaTitle': '了解更多关于我们',
    'about.ctaDescription': '欢迎联系我们，了解更多关于AAC Optics的信息和我们的光学解决方案',
    'about.contactUs': '联系我们',
    'about.downloadBrochure': '下载公司简介',
    'about.values.quality.title': '质量第一',
    'about.values.quality.description': '严格的质量控制体系，确保每一件产品都达到最高标准',
    'about.values.innovation.title': '技术创新',
    'about.values.innovation.description': '持续投入研发，推动光学技术的发展和应用',
    'about.values.customer.title': '客户至上',
    'about.values.customer.description': '以客户需求为导向，提供专业的解决方案和服务',
    'about.values.integrity.title': '诚信经营',
    'about.values.integrity.description': '诚实守信，建立长期稳定的合作关系',
    'about.milestones.2010': '公司成立，专注光学器件研发',
    'about.milestones.2013': '获得ISO9001质量认证',
    'about.milestones.2016': '推出第一代高精度光学系统',
    'about.milestones.2019': '成立国际业务部，拓展海外市场',
    'about.milestones.2022': '获得多项光学技术专利',
    'about.milestones.2024': '成为行业领先的光学解决方案提供商',
